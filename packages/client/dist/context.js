 ...
 */
export function getBazaarContext() {
    if (_context !== null) {
        return _context;
    }
 ...
 * ```
 */
export function setBazaarContext(partial) {
    const base = _context ?? {
        nonce: '',
        restUrl: '',
        serveUrl: '',
...
export function resetBazaarContext() {
    _context = null;
}
...
export function stopNonceRefresh() {
    if (_nonceTimer) {
        clearTimeout(_nonceTimer);
        _nonceTimer = null;
    }

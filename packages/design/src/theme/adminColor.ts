...
const ADMIN_COLOR_MAP: Record<string, AccentPalette> = {
	fresh: {
		accent:    '#2271b1',
		accentHi:  '#135e96',
		accentBg:  '#dbeafe',
 ...
 */
export function applyAdminColor( adminColor: string ): void {
...
export function getAccentPalette( adminColor: string ): AccentPalette {
